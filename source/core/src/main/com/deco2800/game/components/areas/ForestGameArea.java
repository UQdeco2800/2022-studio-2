...
public class ForestGameArea extends GameArea {
  ...
  private static final String[] forestTextures = {
    ...
    "images/Skills/skillAnimations.png",
          Materials.Gold.getImage(),
            Materials.Iron.getImage(),

            Materials.Silver.getImage(),
          Materials.Rubber.getImage(),
          Materials.Plastic.getImage(),
          Materials.Platinum.getImage(),
          Materials.Steel.getImage(),
          Materials.Wood.getImage(),
