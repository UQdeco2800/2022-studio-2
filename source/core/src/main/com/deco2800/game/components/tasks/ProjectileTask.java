...
public class ProjectileTask extends DefaultTask implements PriorityTask{
     ...
     */
    public ProjectileTask(Entity target, Entity projectile, int priority, float viewDistance,
    ...
    public void start() {
        ...
        taskShoot = new ProjectileTask(target, projectile, priority, viewDistance, maxShootDistance, speed, waitTime);
    ...
    public void shoot(Entity projectile) {
