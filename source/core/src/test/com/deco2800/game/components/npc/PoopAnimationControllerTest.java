...
public class PoopAnimationControllerTest {
    @BeforeEach
    void beforeEach() {
    ...
    void createTest() {
        ...
        PoopAnimationController poopAnimationController = new PoopAnimationController();
        poopAnimationController.setEntity(entity);
        poopAnimationController.create();
